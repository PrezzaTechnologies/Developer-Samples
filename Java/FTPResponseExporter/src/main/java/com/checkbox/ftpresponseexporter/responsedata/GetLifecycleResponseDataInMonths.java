 ...
 *         &lt;element name="numberOfRecentMonths" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = {
    "authTicket",
    "surveyId",
    "numberOfRecentMonths"
})
@XmlRootElement(name = "GetLifecycleResponseDataInMonths", namespace = "http://tempuri.org/")
public class GetLifecycleResponseDataInMonths {
    ...
    @XmlElement(namespace = "http://tempuri.org/")
    protected Integer numberOfRecentMonths;
    ...
    /**
     * Gets the value of the numberOfRecentMonths property.
     * 
     * @return
     *     possible object is
     *     {@link Integer }
     *     
     */
    public Integer getNumberOfRecentMonths() {
        return numberOfRecentMonths;
    }

    /**
     * Sets the value of the numberOfRecentMonths property.
     * 
     * @param value
     *     allowed object is
     *     {@link Integer }
     *     
     */
    public void setNumberOfRecentMonths(Integer value) {
        this.numberOfRecentMonths = value;
    }
