 ...
 *         &lt;element name="responseList" type="{http://schemas.microsoft.com/2003/10/Serialization/Arrays}ArrayOflong" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "DeleteSurveyResponses", namespace = "http://tempuri.org/")
public class DeleteSurveyResponses {
    ...
    @XmlElementRef(name = "responseList", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOflong> responseList;
     ...
     *     
     */
    public JAXBElement<ArrayOflong> getResponseList() {
        return responseList;
    }
     ...
     *     
     */
    public void setResponseList(JAXBElement<ArrayOflong> value) {
