 ...
 *         &lt;element name="dateFieldName" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ListSurveyResponsesByPeriod", namespace = "http://tempuri.org/")
public class ListSurveyResponsesByPeriod {
    ...
    @XmlElementRef(name = "dateFieldName", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> dateFieldName;
    ...
    /**
     * Gets the value of the dateFieldName property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getDateFieldName() {
        return dateFieldName;
    }

    /**
     * Sets the value of the dateFieldName property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setDateFieldName(JAXBElement<String> value) {
